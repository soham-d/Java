...
public class DB implements DAO{
	...
	void populateAdminUsers() {
		User user1 = new User("Ram Prasad", "ramprasad@example.com", "ram123", 2);
		User user2 = new User("Laksham Singh", "lakshamsingh@example.com", "laksham123", 2);
		set(user1);
		set(user2);
	}
	...
	public void importData() {
		...
		try {
			...
			File file = new File("/Users/kmitshu/Downloads/users-data");
			String[] files = file.list(); // Get Name of all the files in the users-data directory :) 
			
			for(String fileName : files) {
				File userFile = new File("/Users/kmitshu/Downloads/users-data/", fileName);
