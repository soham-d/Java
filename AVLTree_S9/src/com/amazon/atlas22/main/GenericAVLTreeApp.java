...
public class GenericAVLTreeApp {
	...
	public static void main(String[] args) {
		...
		/*GenericNode<Product> rootNode = tree.insert(null, new Product(101, "Water Bottle", 1200));
		tree.insert(rootNode, new Product(201, "Adidas Shoe", 2000));
		tree.insert(rootNode, new Product(756, "Apple iPhone", 10000));
